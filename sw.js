...
// Network-first para HTML/JS/CSS - build 52 (siempre traer lo último).
// Para imágenes y otros assets: cache-first (opcional).
const ASSET_CACHE = "assets-v52-funciones-personas";
...
// build 52: modo Preparar semana, usuarios limitados a Resultados y salientes filtrados solo a locales Villa Fiad.
// build 52: Mi perfil agrega alta, edición y eliminación de bosquejos desde el catálogo admin.

// build 52: revisión estética general, tarjetas, formularios, tablas, navegación y modo móvil.

// build 52: perfiles con aprobación para salir, solo local y PDF de discursantes filtrado por ancianos/siervos ministeriales aprobados.

// build 52: vista previa de documentos sin menú interno y estilo profesional unificado.

// build 52: usuarios comunes acceden a Mi perfil; admin puede cambiar o limpiar perfiles de discursante.

// build 52: Usuarios lee todos los perfiles de Firestore sin orderBy(nombre), permite eliminar perfil y borrar registro como superadmin.

// build 52: Personas queda fusionado dentro de Funciones; permite agregar, editar, eliminar, activar/desactivar y marcar funciones desde una sola página. Menú sin solapa Personas y ajuste PWA/Android.
